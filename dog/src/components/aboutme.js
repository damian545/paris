        ...
        return (
            ...
            <Grid className="contact-grid">
              <Cell className="aboutme" col={8}>
                ...
                I love going to the beach and meeting new friends (sometimes, they are too big or too playfull and they scare me!)
                I also like playing with my toy or sleeping waiting for dinner. On occasions, I will pooh and wee in the house 
                because I fart arse around out the back yard too long and Mummy takes me inside before I can go toilet!! Oopsy, Daddy 
                can clean that up for me..
                </p>                
              </Cell>
              <Cell col={4}>
            <div style={{ textAlign: "center" }}>
              <h3 style={{ paddingTop: "2em", color: "lightyellow", fontFamily: "Lobster, cursive", fontSize:"35px", letterSpacing:"2px"}}>Paris</h3>              
              <img
